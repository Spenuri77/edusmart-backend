...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    // Zapytanie SQL
    $query = "
        SELECT COUNT(DISTINCT students.id) AS total_students FROM students JOIN classes_subjects_teachers ON students.class_id = classes_subjects_teachers.class_id WHERE classes_subjects_teachers.teacher_id = $teacher_id;
    ";
